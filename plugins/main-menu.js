import {
  ...
  *مرحبا بك مستخدم البوت 👋🏻*

*ثم إعادة تصميم البوت بالعربية*

*يمكن لهاذا البوت الاستجابة والإرسال*

*أيضآ يمكنه إرسال التطبيقات والصور والأغاني*


*مدعوم بالذكاء الإستطناعي للإجابة على اسألتك*

*لذا قم بعمنا على انستجرام للمزيد من التقدم* 
...
*قم بالرد على الرسالة وإرسال رقم لكي يعطيك كل الأوامر*
  ╭───────⳹
  │ *1.  قائمة البوت*
  │ *2.  قائمة مطور البوت*
  │ *3.   قاىمة المجموعات*
...
;
  ...
  handler.before = async (m, { conn }) => {
    ...
    if (choice === "1") {
        await conn.sendMessage(m.chat, { image: { url: 'https://i.imgur.com/hYP699a.jpg' },
        caption: botmenu
      }, { quoted:fcontact });
      } else if (choice === "2") {
        await conn.sendMessage(m.chat, { image: { url: 'https://i.imgur.com/hYP699a.jpg' },
        ...
        m.reply('*قم بالرد على الرسالة التي تحتوي على الرقم الخاص بالأوامر التي تحتاج* \n \n مثال : 13.');
      }
